...
public:
	...
	iterator insert(ContentType const &content)
	{
		...
		LinearRegionMapInternals::Node<ContentType> *node
			= new LinearRegionMapInternals::Node<ContentType>(content);
